...
protected:
	 ...
	 * Constructor
	 */
	script(const std::vector<std::uint8_t> & b) {
		operator << (b);
	}
	 ...
	 * operator <<
	 */
	script & operator << (std::uint16_t b) {
		return push_uint64(b);
	}
	 ...
	 * operator <<
	 */
	script & operator << (std::uint32_t b) {
		return push_uint64(b);
	}
	 ...
	 * operator <<
	 */
	script & operator << (std::uint64_t b) {
		return push_uint64(b);
	}
